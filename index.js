...
function filterStudentsByGrade(students, grade) {
  ...
  let result = students.filter((value) => value.grade === grade);
  // console.log(result);
...
function displayGroupedInfo(students) {
  ...
  for (let value of students) {
    ...
    console.log(`Вік: ${value.age}`);
    console.log(`Вік: ${value.subject}`);
    console.groupEnd();
  }
}
...
function countVowelsAndConsonants(word) {
  ...
  for (let value of word) {
    // console.log(value);
    let charWord = value.toLowerCase();
    console.log(charWord);
    if (vowels.includes(charWord)) {
      console.count("Голосних");
    } else if (specChar.includes(charWord)) {
      console.count("Знак пунктуації");
    } else {
